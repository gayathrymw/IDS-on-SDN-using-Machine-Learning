...
class CollectTrainingStatsApp(simple_switch_13.SimpleSwitch13):
    ...
    def __init__(self, *args, **kwargs):
        ...
        file = open("FlowStatssfile.txt","a+")
        file.write('dp_id,in_port,eth_dst,packets,bytes')
        file.close()
        

        file = open("PortStatssfile.txt","a+")
        file.write('dp_id,port_no,rx_bytes,rx_pkts,tx_bytes,tx_pkts')
        file.close()


        file = open("FlowStatssfile_target.txt","a+")
        file.write('target')
        file.close()

        file = open("PortStatssfile_target.txt","a+")
        file.write('target')
        file.close()
    ...
    def _flow_stats_reply_handler(self, ev):
        ...
        file = open("FlowStatssfile.txt","a+")
        file1=open("FlowStatssfile_target.txt","a+")
    ...
    def _port_stats_reply_handler(self, ev):
        ...
        file = open("PortStatssfile.txt","a+")
        file1 = open("PortStatssfile_target.txt","a+")
